...
$CI = require_once $_SERVER['DOCUMENT_ROOT'].'/blog/CI.php';

    $CI = & get_instance();
    $CI->load->library('session'); //if it's not autoloaded in your CI setup
    //return $CI->session->has_userdata('user_id');
   $usuario = $CI->session->userdata('logado');
...
setlocale(LC_CTYPE, 'pt_PT'); //correct transliteration
